...
<body>
  <h1>Eliminar conductores</h1>
  <form action="deleteconductor.php" method="POST" onsubmit="return validarFormulario()">
    <input type="text" name="searchInput" name="id" id="searchInput" placeholder="Introduzca la cédula del conductor">
  ...
  <script>
    function searchProduct() {
      ...
      // Realizar la solicitud AJAX para buscar la información en deleteconductor.php
      var xhr = new XMLHttpRequest();
      xhr.open("POST", "deleteconductor.php", true);
