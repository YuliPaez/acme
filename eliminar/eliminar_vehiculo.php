...
<body>
  ...
  <form action="deletevehiculo.php" method="POST" onsubmit="return validarFormulario()">
  ...
  <script>
    function searchProduct() {
      ...
      // Realizar la solicitud AJAX para buscar la información en deletevehiculo.php
      var xhr = new XMLHttpRequest();
      xhr.open("POST", "deletevehiculo.php", true);
