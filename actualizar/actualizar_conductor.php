...
<body>
  <h1>Actualizar la información del conductor:</h1>
  <form action="modificarconduc.php" method="POST" onsubmit="return validarFormulario()">
    <input type="text" name="id" id="searchInput" placeholder="Introduzca la cédula del conductor">
  ...
  <script>
    function searchProduct() {
      ...
      // Realizar la solicitud AJAX para buscar la información en modificarconduc.php
      var xhr = new XMLHttpRequest();
      xhr.open("POST", "modificarconduc.php", true);
